...
<html>
  ...
  <body class="propiedades-body">
    ...
    elseif ($_POST['dj'] == 'on'){
  	...
  	$mensaje = 'El se�or(a) '.$nombre.', esta interesado en nuestros servicios. Por favor comunicarse al '.$telefono.' en la ciudad de '.$ciudad.' o al correo '.$email.'. Servicio de interes: '.$servicio.'. Comentario o pregunta:'.$comentario;
